...
export const sendBookingConfirmationEmail = async (params: {
  ...
  try {
    ...
    console.log(`[EMAIL] Booking Confirmation Sent to ${params.toEmail}. Preview URL: ${nodemailer.getTestMessageUrl(info)}`);
    return info;
  } catch (error) {
...
export const sendWaitlistOfferEmail = async (params: {
  ...
  try {
    ...
    console.log(`[EMAIL] Waitlist Offer Sent to ${params.toEmail}. Preview URL: ${nodemailer.getTestMessageUrl(info)}`);
    return info;
  } catch (error) {
